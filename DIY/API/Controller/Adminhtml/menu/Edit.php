...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('DIY_API::Menu')
            ->addBreadcrumb(__('DIY API'), __('DIY API'))
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend($id ? 'Редактировать меню' : 'Создать новое меню');
        if($isClause) {
            $resultPage->getConfig()->getTitle()->prepend($id ? 'Редактировать пункт меню' : 'Создать новый пункт меню');
        }
