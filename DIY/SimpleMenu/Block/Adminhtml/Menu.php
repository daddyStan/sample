...
namespace DIY\SimpleMenu\Block\Adminhtml;
...
class Menu extends \Magento\Backend\Block\Widget\Container
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            'grid',
            $this->getLayout()->createBlock('DIY\SimpleMenu\Block\Adminhtml\Menu\Grid', 'diy.menu.grid')
        );
