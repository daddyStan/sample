...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('DIY_SimpleMenu::Menu')
            ->addBreadcrumb(__('DIY SimpleMenu'), __('DIY SimpleMenu'))
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend($id ? 'Edit menu' : 'Add a new menu');
        if($isClause) {
            $resultPage->getConfig()->getTitle()->prepend($id ? 'Edit menu item' : 'Add a new menu item');
        }
